...
import (
	...
	"github.com/ashiqsabith123/auth-svc/pkg/helper/resp"
...
func ConnectToDatabase(config config.Config) *gorm.DB {
	...
	if err != nil {
		log.Fatal(resp.Red("Failed to connect database - ", err))
		return nil
	}
	...
	fmt.Println(resp.Green("Database connected succesfully...."))
